...
var (
	...
	KeyMinValidatorBondAmount = []byte("MinValidatorBondAmount")
)
...
func (p *Params) ParamSetPairs() paramtypes.ParamSetPairs {
	return paramtypes.ParamSetPairs{
		...
		paramtypes.NewParamSetPair(KeyMinValidatorBondAmount, &p.MinValidatorBondAmount, validateMinValidatorBondAmount),
	}
}
