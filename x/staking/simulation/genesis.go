...
func RandomizedGenState(simState *module.SimulationState) {
	...
	params := types.NewParams(simState.UnbondTime, maxVals, 7, histEntries, simState.BondDenom, minCommissionRate, sdkmath.NewInt(types.DefaultMinValidatorBondAmount))
