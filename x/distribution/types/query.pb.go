...
// QueryRatioRequest is the request for the Query/Ratio
// RPC method
type QueryRatioRequest struct {
}

func (m *QueryRatioRequest) Reset()         { *m = QueryRatioRequest{} }
func (m *QueryRatioRequest) String() string { return proto.CompactTextString(m) }
func (*QueryRatioRequest) ProtoMessage()    {}
func (*QueryRatioRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_5efd02cbc06efdc9, []int{20}
}
func (m *QueryRatioRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryRatioRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryRatioRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryRatioRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryRatioRequest.Merge(m, src)
}
func (m *QueryRatioRequest) XXX_Size() int {
	return m.Size()
}
func (m *QueryRatioRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryRatioRequest.DiscardUnknown(m)
}

var xxx_messageInfo_QueryRatioRequest proto.InternalMessageInfo

// QueryRatioResponse is the response type for the Query/Ratio
// RPC method
type QueryRatioResponse struct {
	Ratio Ratio `protobuf:"bytes,1,opt,name=ratio,proto3" json:"ratio"`
}

func (m *QueryRatioResponse) Reset()         { *m = QueryRatioResponse{} }
func (m *QueryRatioResponse) String() string { return proto.CompactTextString(m) }
func (*QueryRatioResponse) ProtoMessage()    {}
func (*QueryRatioResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_5efd02cbc06efdc9, []int{21}
}
func (m *QueryRatioResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryRatioResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryRatioResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryRatioResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryRatioResponse.Merge(m, src)
}
func (m *QueryRatioResponse) XXX_Size() int {
	return m.Size()
}
func (m *QueryRatioResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryRatioResponse.DiscardUnknown(m)
}

var xxx_messageInfo_QueryRatioResponse proto.InternalMessageInfo

func (m *QueryRatioResponse) GetRatio() Ratio {
	if m != nil {
		return m.Ratio
	}
	return Ratio{}
...
// QueryBaseAddressRequest is the request for the Query/BurnAddress
// RPC method
...
// QueryBaseAddressResponse is the response type for the Query/BurnAddress
// RPC method
...
// QueryModeratorRequest is the request for the Query/Moderator
// RPC method
type QueryModeratorRequest struct {
}

func (m *QueryModeratorRequest) Reset()         { *m = QueryModeratorRequest{} }
func (m *QueryModeratorRequest) String() string { return proto.CompactTextString(m) }
func (*QueryModeratorRequest) ProtoMessage()    {}
func (*QueryModeratorRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_5efd02cbc06efdc9, []int{24}
}
func (m *QueryModeratorRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryModeratorRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryModeratorRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryModeratorRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryModeratorRequest.Merge(m, src)
}
func (m *QueryModeratorRequest) XXX_Size() int {
	return m.Size()
}
func (m *QueryModeratorRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryModeratorRequest.DiscardUnknown(m)
}

var xxx_messageInfo_QueryModeratorRequest proto.InternalMessageInfo

// QueryModeratorResponse is the response type for the Query/Moderator
// RPC method
type QueryModeratorResponse struct {
...
func (m *QueryModeratorResponse) Reset()         { *m = QueryModeratorResponse{} }
func (m *QueryModeratorResponse) String() string { return proto.CompactTextString(m) }
func (*QueryModeratorResponse) ProtoMessage()    {}
func (*QueryModeratorResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_5efd02cbc06efdc9, []int{25}
}
func (m *QueryModeratorResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryModeratorResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryModeratorResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryModeratorResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryModeratorResponse.Merge(m, src)
}
func (m *QueryModeratorResponse) XXX_Size() int {
	return m.Size()
}
func (m *QueryModeratorResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryModeratorResponse.DiscardUnknown(m)
}

var xxx_messageInfo_QueryModeratorResponse proto.InternalMessageInfo

func (m *QueryModeratorResponse) GetModeratorAddress() string {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*QueryRatioRequest)(nil), "cosmos.distribution.v1beta1.QueryRatioRequest")
	proto.RegisterType((*QueryRatioResponse)(nil), "cosmos.distribution.v1beta1.QueryRatioResponse")
	proto.RegisterType((*QueryBaseAddressRequest)(nil), "cosmos.distribution.v1beta1.QueryBaseAddressRequest")
	proto.RegisterType((*QueryBaseAddressResponse)(nil), "cosmos.distribution.v1beta1.QueryBaseAddressResponse")
	proto.RegisterType((*QueryModeratorRequest)(nil), "cosmos.distribution.v1beta1.QueryModeratorRequest")
	proto.RegisterType((*QueryModeratorResponse)(nil), "cosmos.distribution.v1beta1.QueryModeratorResponse")
}
...
var fileDescriptor_5efd02cbc06efdc9 = []byte{
	...
	,
}
...
func (c *queryClient) Ratio(ctx context.Context, in *QueryRatioRequest, opts ...grpc.CallOption) (*QueryRatioResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cosmos.distribution.v1beta1.Query/Ratio", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) BaseAddress(ctx context.Context, in *QueryBaseAddressRequest, opts ...grpc.CallOption) (*QueryBaseAddressResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cosmos.distribution.v1beta1.Query/BaseAddress", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Moderator(ctx context.Context, in *QueryModeratorRequest, opts ...grpc.CallOption) (*QueryModeratorResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cosmos.distribution.v1beta1.Query/Moderator", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedQueryServer) Ratio(ctx context.Context, req *QueryRatioRequest) (*QueryRatioResponse, error) {
...
func (*UnimplementedQueryServer) Moderator(ctx context.Context, req *QueryModeratorRequest) (*QueryModeratorResponse, error) {
...
func _Query_Ratio_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmos.distribution.v1beta1.Query/Ratio",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_BaseAddress_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmos.distribution.v1beta1.Query/BaseAddress",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_Moderator_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmos.distribution.v1beta1.Query/Moderator",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (m *QueryRatioRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryRatioRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryRatioRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryRatioResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryRatioResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryRatioResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryModeratorRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryModeratorRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryModeratorRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryModeratorResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryModeratorResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryModeratorResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryRatioRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryRatioResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryModeratorRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryModeratorResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryRatioRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryRatioRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryRatioRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *QueryRatioResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryRatioResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryRatioResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *QueryModeratorRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryModeratorRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryModeratorRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *QueryModeratorResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryModeratorResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryModeratorResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
